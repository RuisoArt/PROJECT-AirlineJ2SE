...
//--------------------------------------------------------------------------------inicializar ciudades y rutas especificamente------------------------------------------------------------------------------
  ...
  //------------------------------------------------------------------------Agregar una nueva ciudad-----------------------------------------------------------------------------------------
    public void agregarciudad()
    {
        ...
        {
        	try {
        		paises = Integer.parseInt( JOptionPane.showInputDialog(" ¿Cuantos paises deseas agregar?: "));
        		break;
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    {
    	int count = 1;
    	JOptionPane.showMessageDialog(null, "La lista de siudades la puedes ver en la terminal del IDE",null,JOptionPane.INFORMATION_MESSAGE, ico.getImgIcono());
